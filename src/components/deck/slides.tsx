     ...
     ========================================================================== */
  {
    ...
    render: () => (
      <div className="slide-content bg-paper text-ink">
        ...
        <div className="relative flex h-full flex-col justify-between px-[100px] py-[80px]">
          {/* Top Header Tag */}
          ...
          <div className="my-auto max-w-[1550px]">
            <h1 className="slide-title-lg text-ink" style={{ fontSize: 94 }}>
              Environmental Advocacy &amp; Community Evidence Gathering
            </h1>
            <div className="mt-8 inline-block brut bg-forest px-10 py-5 text-paper">
              <p className="slide-subtitle text-paper font-display" style={{ fontSize: 40 }}>
      ...
      <SlideLayout index={index} total={total} label="02: Conceptual Foundations">
        ...
        <div className="grid grid-cols-12 gap-8 items-stretch my-auto">
          ...
          <Card className="col-span-7 p-8 flex flex-col justify-between">
            <div>
              <div className="slide-subtitle text-forest font-display" style={{ fontSize: 32 }}>
                A cleanup can be part of advocacy, but it is not advocacy on its own.
              </div>
              <p className="slide-body mt-4 font-semibold opacity-85" style={{ fontSize: 24 }}>
          ...
          {/* Disclaimer callout */}
          <Card tone="forest" className="col-span-5 p-8 flex flex-col justify-between">
            <div>
     ...
     ========================================================================== */
  {
    ...
    render: ({ index, total }) => (
      <SlideLayout index={index} total={total} label="03: The Advocacy Lifecycle" tone="mint">
        ...
        <div className="grid grid-cols-7 gap-4 items-stretch my-auto">
          {[
            ...
            <Card key={item.step} className="p-5 flex flex-col justify-between h-full">
              ...
              <div className="mt-4 border-t-[2px] border-ink/20 pt-3">
                <p className="slide-caption font-semibold opacity-85 leading-snug" style={{ fontSize: 18 }}>
                  {item.question}
                </p>
              </div>
            </Card>
      ...
      <SlideLayout index={index} total={total} label="04: The Evidence Gap">
        <div className="grid grid-cols-12 gap-8 items-stretch my-auto">
          ...
          <Card tone="forest" className="col-span-5 p-10 flex flex-col justify-between">
            <div>
              <div className="slide-kicker text-mint mb-4">Core Reality</div>
              <blockquote className="slide-title text-paper leading-tight" style={{ fontSize: 52 }}>
                “I saw it” is not the same as “I can demonstrate it.”
              </blockquote>
            </div>
            <div className="mt-6 border-t border-paper/20 pt-4">
              <p className="slide-caption text-mint font-semibold" style={{ fontSize: 20 }}>
          ...
          <div className="col-span-7 flex flex-col justify-between gap-4">
            <Card className="px-7 py-4 flex items-center gap-5">
              <span className="text-3xl">📸</span>
              <div>
                <div className="slide-subtitle font-display" style={{ fontSize: 24 }}>Visual Evidence</div>
                <p className="slide-body opacity-85" style={{ fontSize: 20 }}>
            ...
            <Card className="px-7 py-4 flex items-center gap-5">
              ...
              <div>
                <div className="slide-subtitle font-display" style={{ fontSize: 24 }}>Lived Experience</div>
                <p className="slide-body opacity-85" style={{ fontSize: 20 }}>
            ...
            <Card className="px-7 py-4 flex items-center gap-5">
              <span className="text-3xl">📊</span>
              <div>
                <div className="slide-subtitle font-display" style={{ fontSize: 24 }}>Quantitative Data</div>
                <p className="slide-body opacity-85" style={{ fontSize: 20 }}>
            ...
            <Card className="px-7 py-4 flex items-center gap-5">
              <span className="text-3xl">⏱️</span>
              <div>
                <div className="slide-subtitle font-display" style={{ fontSize: 24 }}>Longitudinal Tracking</div>
                <p className="slide-body opacity-85" style={{ fontSize: 20 }}>
        ...
        {/* Bottom Takeaway */}
        <Card tone="accent" className="px-8 py-3.5 text-center">
          <span className="slide-subtitle font-display text-forest-deep" style={{ fontSize: 28 }}>
     ...
     ========================================================================== */
  {
    ...
    render: ({ index, total }) => (
      <SlideLayout index={index} total={total} label="05: Evidence Taxonomy">
        ...
        <Card tone="mint" className="px-8 py-3 text-center">
          <span className="slide-body font-bold text-forest-deep" style={{ fontSize: 24 }}>
     ...
     ========================================================================== */
  {
    ...
    render: ({ index, total }) => (
      <SlideLayout index={index} total={total} label="06: Methodology Shift">
        ...
        <div className="grid grid-cols-2 gap-8 items-stretch my-auto">
          ...
          <Card tone="muted" className="p-8 flex flex-col justify-between">
            <div>
              ...
              <h3 className="slide-subtitle font-display mt-3 text-ink" style={{ fontSize: 32 }}>
                The Activity-First Approach
              </h3>
              <div className="mt-6 brut-flat border-[2px] bg-white p-5">
                <p className="slide-body font-bold text-red-900 tracking-wide" style={{ fontSize: 22 }}>
                  Problem → Activity → Pictures → Publicity → Move on
                </p>
              </div>
              <ul className="mt-6 space-y-3">
                <li className="flex items-start gap-3">
                  <span className="mt-2 h-3.5 w-3.5 shrink-0 rounded-full bg-red-600" />
                  <span className="slide-body opacity-90" style={{ fontSize: 22 }}>
          ...
          <Card tone="forest" className="p-8 flex flex-col justify-between">
            <div>
              ...
              <h3 className="slide-subtitle font-display mt-3 text-paper" style={{ fontSize: 32 }}>
                The Evidence-Backed Approach
              </h3>
              <div className="mt-6 brut-flat border-[2px] border-paper bg-forest-deep p-5">
                <p className="slide-body font-bold text-mint tracking-wide" style={{ fontSize: 22 }}>
                  Problem → Investigate → Gather evidence → Act → Measure change → Follow up
                </p>
              </div>
              <ul className="mt-6 space-y-3">
                <li className="flex items-start gap-3">
                  <span className="mt-2 h-3.5 w-3.5 shrink-0 border-[2px] border-paper bg-mint" />
                  <span className="slide-body opacity-95 text-paper" style={{ fontSize: 22 }}>
        ...
        <Card tone="accent" className="p-5 text-center">
          <p className="slide-subtitle font-display text-forest-deep" style={{ fontSize: 28 }}>
     ...
     ========================================================================== */
  {
    ...
    render: ({ index, total }) => (
      <SlideLayout index={index} total={total} label="07: The Framework" tone="mint">
        ...
        <div className="grid grid-cols-7 gap-3.5 items-stretch my-auto">
          {[
            {
              step: "01",
              phase: "CONCERN",
            ...
            <Card key={col.step} className="p-4 flex flex-col justify-between h-full">
              <div>
                <span className="slide-kicker text-forest font-bold">{col.step}</span>
                <h3 className="slide-subtitle font-display mt-1" style={{ fontSize: 20 }}>
                  {col.phase}
                </h3>
                <div className="mt-3 brut-flat border-[2px] bg-mint/40 p-2.5">
                  <p className="slide-caption font-extrabold text-forest-deep leading-tight" style={{ fontSize: 16 }}>
                    {col.question}
                  </p>
                </div>
              </div>
              <p className="slide-caption mt-3 opacity-80 leading-relaxed" style={{ fontSize: 15 }}>
                {col.desc}
              </p>
            </Card>
          ))}
        ...
        <div className="grid grid-cols-12 gap-8 items-stretch my-auto">
          ...
          <Card className="col-span-5 p-8 flex flex-col justify-between">
            ...
            <div className="mt-6 border-t border-ink/20 pt-3">
              <p className="slide-caption font-bold text-forest-deep" style={{ fontSize: 18 }}>
          ...
          <div className="col-span-7 flex flex-col justify-between gap-5">
            <Card tone="forest" className="p-7">
              ...
              <p className="slide-subtitle text-paper mt-2 font-display" style={{ fontSize: 32 }}>
                Field observation and community engagement helped reveal the scale of the problem:
              </p>
              <div className="mt-5 brut-flat border-[3px] border-paper bg-forest-deep p-5">
                <p className="slide-body-lg font-bold text-mint" style={{ fontSize: 32 }}>
                  “The issue was far bigger than cleaning up waste.”
                </p>
              </div>
            </Card>

            <Card tone="accent" className="p-7">
              <span className="slide-kicker text-forest-deep">Integrated Intervention</span>
              <p className="slide-body font-bold text-forest-deep mt-2" style={{ fontSize: 24 }}>
        ...
        <div className="grid grid-cols-12 gap-8 items-stretch my-auto">
          ...
          <Card className="col-span-7 p-8 flex flex-col justify-between">
            <div className="space-y-4">
              <p className="slide-body leading-relaxed" style={{ fontSize: 24 }}>
              ...
              <div className="brut-flat border-[3px] bg-mint-soft p-5">
                <p className="slide-body font-semibold text-forest-deep" style={{ fontSize: 23 }}>
              ...
              <p className="slide-body font-bold text-forest leading-relaxed" style={{ fontSize: 24 }}>
            ...
            <div className="mt-5 border-t border-ink/20 pt-3">
              <span className="slide-caption font-extrabold uppercase text-forest tracking-wider" style={{ fontSize: 16 }}>
          ...
          <div className="col-span-5 flex flex-col justify-between gap-5">
            <Card tone="forest" className="p-7">
              ...
              <p className="slide-subtitle text-paper mt-2 leading-snug font-display" style={{ fontSize: 28 }}>
            ...
            <Card className="p-6">
              <div className="slide-kicker text-forest mb-3">Accessible Project Media</div>
              <div className="flex flex-col gap-2.5">
                <a
                  href="https://youtube.com/shorts/NB2ybNE5ZNU?si=CQiaVeIsidrp9kYp"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="deck-ui-btn px-4 py-2.5 text-left w-full flex flex-col justify-center"
                >
    ...
    render: ({ index, total }) => (
      <SlideLayout index={index} total={total} label="10: Global & Regional Cases">
        ...
        <div className="grid grid-cols-3 gap-6 my-auto">
          ...
          <Card className="p-7 flex flex-col justify-between h-full">
            <div>
              ...
              <p className="slide-caption mt-3 leading-relaxed opacity-90" style={{ fontSize: 17 }}>
            ...
            <div className="mt-5 pt-3 border-t border-ink/20">
              <a
                href="https://www.amnesty.org/en/latest/news/2018/03/Niger-Delta-Oil-Spills-Decoders/"
                target="_blank"
                rel="noopener noreferrer"
                className="deck-ui-btn px-4 py-2 w-full flex flex-col"
              >
                <div className="flex items-center justify-between font-bold text-xs">
                  <span>Read Decode Oil Spills</span>
                  <span>↗</span>
                </div>
                <span className="text-[10px] opacity-75 font-mono truncate text-left">
        ...
        <Card tone="forest" className="p-4 text-center">
          <span className="slide-body font-bold text-mint" style={{ fontSize: 24 }}>
    ...
    render: ({ index, total }) => (
      <SlideLayout index={index} total={total} label="11: Operational Methodology" tone="mint">
        ...
        <div className="grid grid-cols-3 gap-6 items-stretch my-auto">
          ...
          <Card className="p-7 flex flex-col justify-between h-full">
            <div>
              <div className="flex items-center justify-between border-b-[2px] border-ink pb-2.5">
                <h3 className="slide-subtitle font-display text-forest" style={{ fontSize: 28 }}>
                  BEFORE
                </h3>
                <span className="slide-badge brut-flat border-[2px] bg-mint px-3 py-0.5 font-bold text-xs">
                  Preparation
                </span>
              </div>
              <ul className="mt-5 space-y-3">
            ...
            <div className="mt-5 text-xs uppercase tracking-wider text-forest font-bold border-t border-ink/20 pt-2.5">
              Research &amp; Scoping
            </div>
          </Card>
          ...
          <Card className="p-7 flex flex-col justify-between h-full">
            <div>
              <div className="flex items-center justify-between border-b-[2px] border-ink pb-2.5">
                ...
                <span className="slide-badge brut-flat border-[2px] bg-forest px-3 py-0.5 font-bold text-xs text-paper">
                  Fieldwork
                </span>
              </div>
        ...
        <Card tone="forest" className="px-8 py-3 text-center">
          <p className="slide-body font-bold text-paper" style={{ fontSize: 22 }}>
    ...
    render: ({ index, total }) => (
      <SlideLayout index={index} total={total} label="15: Resources & References" tone="paper">
        ...
        <div className="grid grid-cols-3 gap-6 items-stretch my-auto">
          ...
          <Card className="p-6 flex flex-col justify-between h-full">
            <div>
              <div className="flex items-center gap-2 border-b-[2px] border-ink pb-2">
                <span className="text-xl">🌊</span>
                <h3 className="slide-subtitle font-display text-forest" style={{ fontSize: 24 }}>
                  WaveWise Project
                </h3>
              ...
              <div className="mt-4 flex flex-col gap-2.5">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="deck-ui-btn px-3 py-2 text-left w-full flex flex-col"
                >
                  <span className="font-bold text-xs flex justify-between">
                    <span>Short Video Summary</span>
                    <span className="text-forest">↗</span>
                  </span>
                  <span className="text-[10px] font-mono opacity-70">youtube.com/shorts/NB2ybNE5ZNU</span>
                </a>
                ...
                >
                  ...
                  <span className="text-[10px] font-mono opacity-70">youtu.be/Xb348ZCMDSc</span>
                </a>
                ...
                >
                  ...
                  <span className="text-[10px] font-mono opacity-70">instagram.com/wavewisecrp</span>
                </a>
              </div>
            </div>
            <div className="mt-4 border-t border-ink/20 pt-2 text-[11px] font-bold uppercase text-forest">
              Grassroots Evidence In Action
            </div>
          </Card>

          {/* Column 2: Institutional Case Studies */}
          <Card tone="forest" className="p-6 flex flex-col justify-between h-full">
            <div>
              <div className="flex items-center gap-2 border-b border-paper/20 pb-2">
                <span className="text-xl">📄</span>
                <h3 className="slide-subtitle font-display text-mint" style={{ fontSize: 24 }}>
                  Case Study Reports
                </h3>
              </div>
              ...
              <div className="mt-4 flex flex-col gap-2.5">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="deck-ui-btn px-3 py-2 text-left w-full flex flex-col bg-paper text-ink"
                >
                  <span className="font-bold text-xs flex justify-between">
                    <span>Amnesty: Decode Oil Spills</span>
                    <span className="text-forest">↗</span>
                  </span>
                  <span className="text-[10px] font-mono opacity-70 truncate">amnesty.org/.../Niger-Delta-Oil-Spills</span>
                </a>
                ...
                >
                  ...
                  <span className="text-[10px] font-mono opacity-70 truncate">unep.org/.../environmental-assessment</span>
                </a>
                ...
                >
                  ...
                  <span className="text-[10px] font-mono opacity-70">report.bayelsacommission.org</span>
                </a>
              </div>
            </div>
            <div className="mt-4 border-t border-paper/20 pt-2 text-[11px] font-bold uppercase text-mint">
              Institutional Precedents
            </div>
          </Card>

          {/* Column 3: Toolkits & Connect */}
          <Card tone="accent" className="p-6 flex flex-col justify-between h-full">
            <div>
              <div className="flex items-center gap-2 border-b-[2px] border-ink pb-2">
                <span className="text-xl">🛠️</span>
                <h3 className="slide-subtitle font-display text-forest-deep" style={{ fontSize: 24 }}>
              ...
              <div className="mt-4 flex flex-col gap-2.5">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="deck-ui-btn px-3 py-2 text-left w-full flex flex-col bg-mint border-[2px]"
                >
                  <span className="font-bold text-xs flex justify-between text-forest-deep">
                    <span>Sheriffdeen Saula Linktree</span>
                    <span>↗</span>
                  </span>
                  <span className="text-[10px] font-mono opacity-80 text-forest-deep">linktr.ee/SheriffdeenSaula</span>
                </a>
              </div>
            </div>
            <div className="mt-4 border-t border-ink/20 pt-2 text-[11px] font-bold uppercase text-forest-deep">
              Community Tooling
            </div>
          </Card>
        </div>
